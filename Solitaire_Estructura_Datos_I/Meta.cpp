...
/*
 Aqui esta todo lo que vamos a necesitar para poder hacer funcionar el juegom, cartas, el tipo, el paquete a que pertenecen, si esta o no oculta, las animaciones, en caso que este o no vacio, altura y anchura..
